...
import SocialAuthForm from "@/components/SocialAuthForm"; // <--- Import this
    ...
    <div className="glass p-8 border border-dark-200 rounded-2xl shadow-2xl">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
         ...
         <div className="flex flex-col gap-2">
             ...
             <input name="email" type="email" required className="bg-dark-200 border border-border-dark rounded-lg px-4 py-3 text-white focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all" />
         </div>

         <div className="flex flex-col gap-2">
             <label className="text-sm font-medium text-light-100">Password</label>
             <input name="password" type="password" required className="bg-dark-200 border border-border-dark rounded-lg px-4 py-3 text-white focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all" />
         </div>
